...
def test_development_baseline_registers_every_owner_table() -> None:
    expected = set().union(
        ...
        conversation_review.CONVERSATION_REVIEW_OWNER_TABLES,
        consolidator.CONSOLIDATOR_OWNER_TABLES,
        learner.LEARNER_OWNER_TABLES,
        ...
        skill_designer.SKILL_DESIGNER_OWNER_TABLES,
