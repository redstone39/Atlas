...
JSONB_PAYLOAD_REGISTRY: dict[str, tuple[str, int, str]] = {
    ...
    "atlas_consolidation_runs.result_payload": ("learning_metadata", GENERAL_METADATA_MAX_BYTES, "consolidation_v1"),
    "atlas_learner_runs.experience_payload": ("learning_metadata", GENERAL_METADATA_MAX_BYTES, "learner_experience_v1"),
    "atlas_skill_candidates.draft_payload": ("learning_metadata", GENERAL_METADATA_MAX_BYTES, "skill_candidate_draft_v1"),
    "atlas_skill_candidates.approved_skill_ref": ("learning_metadata", RUNTIME_POLICY_MAX_BYTES, "prompt_skill_ref_v1"),
    "atlas_skill_candidate_idempotency.response_payload": ("idempotency_response", RUNTIME_POLICY_MAX_BYTES, "skill_candidate_mutation_replay_v1"),
