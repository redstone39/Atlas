...
JSONB_PAYLOAD_REGISTRY: dict[str, tuple[str, int, str]] = {
    ...
    "atlas_note_revisions.change_set": ("collaboration_delta", 1_048_576, "note_revision_change_set"),
    "atlas_note_savepoints.aggregate_change_set": ("collaboration_delta", 1_048_576, "note_savepoint_change_set"),
    "atlas_note_savepoints.canonical_body": ("collaboration_document", 1_048_576, "note_canonical_body"),
    "atlas_note_savepoints.contributor_actor_ids": ("authorization_projection", 1_048_576, "note_savepoint_contributors"),
